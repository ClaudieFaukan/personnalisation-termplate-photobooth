    ...
    */
    ...
    <section class="page-section portfolio" id="portfolio">
        ...
        <div class="row" style="margin-bottom:13px;">
            <!-- POLICE -->
            <div>
                <span style="margin-left:27px"><i class="fas fa-font"></i> : Police </span>
        ...
        <center>
            ...
            <h3>Format paysage 1 pose</h3>
            <?php $all = $_GET["all"];
            if ($all == "true") {
                echo ('<h4>Etape 3/7</h4>');
            } else {
                ...
                if (all == "true") {
                    $.ajax({
                        ...
                        data: {
                            ...
                            "format": "paysage_1pose",
                            "mail": mail,
                            "commande": commande
                        },
                    }).then(() => {
                        var link = document.createElement("a");
                        link.href = "/photobooth-custom/templatePaysage2.php?mail=" + mail +
                            "&commande=" + commande +
                            "&all=" + all +
                    ...
                    $.ajax({
                        ...
                        var link = document.createElement("a");
                        link.href = "/templatePaysage2.php?mail=" + mail +
                            "&commande=" + commande +
                            "&all=" + all +
