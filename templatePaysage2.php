    ...
    */
    ...
    <section class="page-section portfolio" id="portfolio">
        ...
        <center>
            ...
            <h3>Format paysage 4 poses</h3>
            <?php
            $all = $_GET["all"];
            if ($all == "true") {
                echo ('<h4>Etape 4/7</h4>');
            } else {
                echo ('<h4>Etape 2/2</h4>');
            }
            ?>
            <div id="backgroundcanvas" style="background-color:#444;padding:15px; display:none; width: 1800px; ">
    ...
    <script>
        ...
        function chooseTemplate(e, getText, optionsGetUser) {
            ...
            if (canvas == null) {
                id = e;
                path = "src/theme/" + id + "/01_PNG/" + id + "_PAYSAGE_4POSES.png";
        ...
        $('#NextStep').on('click', () => {
            if (options["template"] != "nothing") {
                ...
                if (all == "true") {
                    pathUrl = "/photobooth-custom/templatePortrait.php?mail=" + mail +
                        "&commande=" + commande +
                        "&all=" + all +
