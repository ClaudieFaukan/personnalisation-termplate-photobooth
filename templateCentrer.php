    ...
    */
    ...
    <section class="page-section portfolio" id="portfolio">
        <div class="container text-center col-sm-12">
            ...
            <!--CATALOGUE -->
            <div class="mx-auto" style="margin-bottom: 15px" id="catalogue">
            ...
            <div class="row" style="margin-bottom:13px;">
                ...
                <div>
                    ...
                    <select name="Police" id="police" title="Choix de la police">
                        ...
                        <option id="acme" style="font-family:'Acme'">Acme</option>
                        <option id="alex-brush" style="font-family:'Alex Brush'">Alex Brush</option>
                        <option id="amatic-sc" data-font="Amatic SC">Amatic SC</option>
                        <option id="audiowide" style="font-family:'Audiowide'">Audiowide</option>
                        ...
                        <option id="tangerine" style="font-family:'Tangerine'">Tangerine</option>
                    </select>
                </div>
                <!--    SIZE POLICE -->
        ...
        <center> 
            ...
            <h3>Format centrer 1 pose</h3> 
            <?php $all = $_GET["all"];
            if($all == "true"){
                echo('<h4>Etape 1/7</h4>');
            }else{
    ...
    <script>
        ...
        function chooseTemplate(e){
            ...
            if(canvas == null){
                id = e;
                path = "src/theme/"+id+"/01_PNG/"+id+"_CENTRE_1POSE.png";
                ...
                text = new fabric.Textbox('Déplacer votre texte en cliquant içi',{
                    left:350,
                    top:10,
                    width:600
                })
