    ...
    */
    ...
    <section class="page-section portfolio" id="portfolio">
                    ...
                    <?php for ($i = 0; $i <= 100; $i++) {
                        if ($i == 0) {
                            ...
                            echo ('<div class="carousel-item" >
                                ...
                                <div class="row">
                                <button class="mx-auto text-center" style="margin-top: 20px; margin-bottom:20px;padding: 7px; border-radius:5px; border-color:#ff4297"onclick="chooseTemplate(' . $i . ',Saisir un texte)">Choisir ce template</button>
                                </div>
                            </div>
                            ');
                        }
        ...
        <div class="row mx-auto">
            ...
            <button class="btn btn-success" title="NextStep" id="NextStep" style="margin-top: 20px; margin-bottom:20px"><i class="fas fa-save"></i>Valider ma personnalisation</button>
        ...
        <center>
            ...
            <h3>Format strip 3 poses</h3>
            <?php
            $all = $_GET["all"];
            if ($all == "true") {
                echo ('<h4>Etape 7/7</h4>');
            } else {
                echo ('<h4>Etape 1/1</h4>');
            }
            ?>
            <div id="backgroundcanvas" style="background-color:#444;padding:15px; display:none; width: 1200px; height:1500 px ">
    ...
    ?>
    <script>
        /******************* RECUPERATION DES OPTIONS ET CREATION DU CANVA ADAPTEE **************** */
        ...
        function chooseTemplate(e, getText, optionsGetUser) {
            ...
            if (canvas == null) {
                id = e;
                path = "src/theme/" + id + "/01_PNG/" + id + "_STRIP_3POSES.png";
                ...
                text2 = new fabric.Textbox(getText, optionsGetUser);
                canvas.add(text);
                canvas.add(text2);
            } else {
                id = e;
        ...
        //DEFINITION DES OPTIONS POSSIBLE PAR DEFAUT
        var options = {
            fontWeight: "normal",
            fontSize: 40,
            fontFamily: "sans-serif",
        ...
        $("#ok").on('click', () => {
            if (options["template"] == "nothing") {
                ...
                text2 = new fabric.Textbox(valueText, options);
                canvas.add(text);
                canvas.add(text2);
