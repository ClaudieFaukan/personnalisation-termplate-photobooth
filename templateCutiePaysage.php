    ...
    */
    ...
    <section class="page-section portfolio" id="portfolio">
        ...
        <center>
            ...
            <h3>Format cutiebox paysage</h3>
            <h4>Etape 2/2</h4>
            <div id="backgroundcanvas" style="background-color:#444;padding:15px; display:none; width: 1400px; ">
    ...
    <script>
        ...
        function chooseTemplate(e, getText, optionsGetUser) {
            ...
            if (canvas == null) {
                id = e;
                path = "src/theme/" + id + "/01_PNG/" + id + "_CUTIEBOX_PAYSAGE.png";
            ...
            if (options["template"] != "nothing") {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        "format": "cutiebox_paysage",
                        "mail": mail,
                        "commande": commande
                    },
                }).then(() => {
                    var link = document.createElement("a");
                    link.href = "/photobooth-custom/finish.php",
                        link.click();
                    link.delete;
                });
