    ...
    */
    ...
    <section class="page-section portfolio" id="portfolio">
        ...
        <center>
            ...
            <h3>Format portrait 4 poses</h3>
            <?php $all = $_GET["all"];
            if ($all == "true") {
                echo ('<h4>Etape 6/7</h4>');
            } else {
    ...
    <script>
        ...
        function chooseTemplate(e, getText) {
            $("#backgroundcanvas").show();
            if (canvas == null) {
                id = e;
                path = "src/theme/" + id + "/01_PNG/" + id + "_PORTRAIT_4POSES.png";
