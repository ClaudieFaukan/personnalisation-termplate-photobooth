    ...
    */
    ...
    <section class="page-section portfolio" id="portfolio">
        ...
        <div class="row mx-auto">
            ...
            $all = $_GET["all"];
            if ($all == "true") {
                echo ('<button class="btn btn-success" title="NextStep" id="NextStep" style="margin-top: 20px; margin-bottom:20px">Etape suivante</button>');
            } else {
                echo ('<button class="btn btn-success" title="NextStep" id="NextStep" style="margin-top: 20px; margin-bottom:20px"><i class="fas fa-save"></i>Valider ma personnalisation</button>');
            }
            ?>
        </div>
        ...
        <center>
            ...
            <h3>Format centrer 4 poses</h3>
            <?php
            $all = $_GET["all"];
            if ($all == "true") {
                echo ('<h4>Etape 2/7</h4>');
            } else {
                echo ('<h4>Etape 2/2</h4>');
            }
            ?>
            <div id="backgroundcanvas" style="background-color:#444;padding:15px; display:none; width: 1200px; ">
    ...
    <script>
        ...
        function chooseTemplate(e, text, optionsGetUser) {
            $("#backgroundcanvas").show();
            if (canvas == null) {
                id = e;
                path = "src/theme/" + id + "/01_PNG/" + id + "_CENTRE_4POSES.png";
                ...
                text = new fabric.Textbox(text, optionsGetUser)
                canvas.add(text);
            } else {
                id = e;
                path = "src/theme/" + id + "/01_PNG/" + id + "_CENTRE_4POSES.png";
